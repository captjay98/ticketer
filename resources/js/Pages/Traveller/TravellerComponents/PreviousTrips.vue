...
<template>
    <div class="py-4 px-4 m-auto w-full rounded-md bg-yellow-50/10">
        ...
        <div class="overflow-auto py-1 m-auto w-full rounded-lg h-[25rem]">
            <table
            ...
            >
                <thead class="text-left rounded-lg bg-gray-200/40 text-[13px]">
                    <tr class="text-left border-inherit">
                        <th class="py-2 px-2 text-center text-green-600">ID</th>
                ...
                <tbody class="rounded-lg divide-solid bg-green-50/30">
                    ...
                    >
                        ...
                        <td class="pl-4 leading-5 min-w-[50px] max-w-[180px]">
                        ...
                        >
                            <Link
                                v-if="trip.ticket && trip.ticket.id"
                                :href="route('ticket.show', trip.ticket.id)"
                            >
                                {{ trip.ticket.id }}
                            </Link>
