        ...
        <div class="rounded-lg w-[95%] m-auto min-h-auto">
            ...
            >
                <div class="rounded-lg bg-[hsla(0,0%,0%,0.6)] h-full">
                    <div
                        class="flex z-0 flex-col justify-center items-center m-auto text-white relativ"
                    >
                        <div class="my-20 max-sm:my-10">
                            <h1
                                class="text-4xl tracking-tight text-center max-sm:text-[2rem]"
                            >
                            ...
                            <p
                                class="mt-2 text-xl text-center max-sm:text-[14px] max-sm:px-12"
                            >
                        ...
                        <form
                            ...
                            class="flex relative flex-wrap justify-center py-1 px-1 mt-4 rounded-md md:justify-start bottom-[3rem] max-sm:bottom-[2rem]"
                        >
                            <label for="source" class="sr-only">Source</label>
                            <select
                                class="h-14 text-center bg-yellow-50 rounded-l-2xl border-none focus:ring-0 focus:outline-none w-[7.5rem] max-md:text-[0.85rem] text-slate-900 xl:w-[180px]"
                                required
                                name="source"
                                id="source"
                                v-model="form.source"
                            ...
                            >
                            <select
                                class="h-14 text-center bg-yellow-50 border-none focus:ring-0 focus:outline-none w-[7.5rem] max-md:text-[0.85rem] text-slate-900 xl:w-[180px]"
                                required
                                name="destination"
                                id="destination"
                            ...
                            >
                                ...
                                <option
                                    class="rounded-md hover:bg-green-400 active:bg-green-400 text-md"
                            ...
                            <input
                                class="h-14 text-center bg-yellow-50 border-none focus:outline-none w-[7.5rem] max-md:text-[0.85rem] max-sm:rounded-r-2xl text-slate-900 xl:w-[180px] focus:ring-none"
                                disabled
                                type="date"
                                :v-model="form.date"
                                id="date"
            ...
            <div class="mt-12 h-auto bg-yellow-50/20 max-sm:mt-28">
                    ...
                    >
                        ...
                        >
                            <img
                                ...
                                width="300"
                                height="300"
                                :src="'/storage/home-images/kaduna-station.webp'"
                                alt="Train Station"
                            />
                            <span
                                className="relative bottom-8 py-1 px-4 ml-2 text-center text-white rounded-lg text-[12px] bg-black/70"
                                >Kaduna
                            </span>
                        </div>
                        <div
                        ...
                        >
                            <img
                                ...
                                width="200"
                                height="200"
                                :src="'/storage/home-images/abuja-station.webp'"
                                alt="Train Station"
                            />
                            <span
                                className="relative bottom-8 py-1 px-4 ml-2 text-center text-white rounded-lg text-[12px] bg-black/70"
                        ...
                        >
                            <img
                                class="w-full h-full bg-white rounded-lg shadow-xl"
                                :src="'/storage/home-images/lagos-station.webp'"
                                width="300"
                                height="300"
                                alt="Train Station"
                            />
                        ...
                        >
                            <img
                                class="w-full h-full bg-white rounded-lg shadow-xl hover:shadow-2xl"
                        ...
                        >
                            <img
                                class="w-full h-full bg-white rounded-lg shadow-xl hover:shadow-2xl"
                                :src="'/storage/home-images/ibd-sta.webp'"
                                width="300"
                                height="300"
                                alt="Train Station"
                            />
                        ...
                        >
                            <img
                                class="w-full h-full bg-white rounded-lg shadow-xl hover:shadow-2xl"
                                :src="'/storage/home-images/station.webp'"
                                width="300"
                                height="300"
                                alt="Train Station"
                            />
                ...
                <div class="py-8 mt-8 min-h-auto bg-green-50/20">
                    ...
                    <div
                        v-if="trips.length > 0"
                        class="flex overflow-x-auto py-8"
                    >
                        <div
                            v-for="trip in trips"
                            :key="trip.id"
                            class="mx-5 mt-2 rounded-lg shadow-2xl bg-yellow-50/50 h-[13.5rem] w-[20rem]"
                        >
                            <Link :href="route('trips.one', trip.id)">
                                ...
                                <div class="px-3 pt-0 text-center">
                                    ...
                                    <p class="font-semibold text-[1.0rem]">
                                        ...
                                        NGN{{
                                            trip.ticket_types[0]?.price ?? 4000
                                        }}
                                    </p>
                                </div>
                            </Link>
            ...
            <div class="py-8 bg-yellow-50/20">
                <div class="flex overflow-y-scroll flex-wrap justify-between">
                    <div
                        class="lg:w-[30%] mt-4 md: md:w-[30%] m-auto rounded-xl"
                    >
                        <div class="rounded-xl h-[33rem] w-[16rem]">
                            <video
                                class="w-full rounded-xl"
                                :src="'/storage/home-images/train-vid.mp4'"
                                alt="Train Interior"
                                autoplay
                                loop
                                muted
                            ...
                            >
                                <track
                                    :src="'/storage/home-images/train-vid.mp4'"
                                    kind="Interior view of the train"
                                />
                            </video>
                        </div>
                    </div>
            ...
            <div class="py-4 px-2 h-auto bg-yellow-50/20">
                <div class="flex flex-wrap justify-center">
                    <div
                        class="grid grid-cols-4 justify-center my-6 xl:gap-20 max-sm:grid max-sm:grid-cols-2"
                    >
                        <div class="my-4 w-48 h-56">
                            <div
                                class="flex flex-wrap py-4 px-6 justify center"
                            >
                                <p class="mt-2 w-full text-5xl text-center">
                                    2M+
                                </p>
                                <p
                                    class="mt-4 w-full font-semibold text-center"
                                >
                                    Passengers Moved
                                </p>
